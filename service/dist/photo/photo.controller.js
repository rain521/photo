...
let PhotoController = class PhotoController {
    ...
    batchCreate(items, req) {
        return this.photoService.bulkCreate(items, req.user.userId);
    }
    async pagination(body, req) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PhotoController.prototype, "batchCreate", null);
__decorate([
...
], PhotoController.prototype, "pagination", null);
__decorate([
    (0, common_1.Get)(':id'),
